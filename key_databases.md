...
Data is from the [SAKE reversing project](https://github.com/OpenMinimed/GhidraProjects), mainly the function at <code>0x0001dcf0</code>. There was a small update to this list in the Guardian app, which is highlighted in *italic*.
